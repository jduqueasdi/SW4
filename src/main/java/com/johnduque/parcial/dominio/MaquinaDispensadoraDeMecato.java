...
public class MaquinaDispensadoraDeMecato {
    ...
    public void cargarInventario(String codigo, byte cantidad){
        ...
        if(existePdto){
            ...
            byte cantidadActual = (byte) (producto.getCantidadActual()
            + cantidad);
    ...
    public void sacarProductoNombre(String nombre, short dinero){
        ...
        if(existePdto){
            ...
            producto.getCantidadActual()>0 &&
                ...
                producto.setCantidadActual(cantidadActual);
                System.out.println("Reciba su" + producto.getNombre() +
                        " su cambio es de: "+ (dinero-producto.getPrecio()) +
                        " pesos");
            }else{
    ...
    public List<Producto> consultarTotalUndsTodosPdtos(){
